...
class Upload extends Component {
  ...
  handlePath() {
    ...
    if (validate) {
      ...
      let S3path = "s3://adx-design-assets/Campaigns/2020/" + S3path2nd;

      let arPath = "https://adx-design-assets.s3.us-west-2.amazonaws.com/Campaigns/2020/" + S3path2nd;
    ...
    if (this.state.SFURL.trim()) {
      await fetch(
        ...
        .then((data) => {
          ...
          // console.log("Advertiser========", assignmentData.Advertiser__c);
              ...
              <Row className="show-grid">
                ...
                <Col className="step-body" xs={7} md={7}>
                  <Row className="show-grid">
                    ...
                    <Col xs={4} md={4}>
                      <span className="input-lable">Local</span>
                      <input
                        className="input-field"
                        spellCheck="false"
                        placeholder="Local"
                    ...
                    <Col xs={4} md={4}>
                      <span className="input-lable">Account verticle</span>
                      <input
                        className="input-field"
                        spellCheck="false"
                    ...
                    <Col xs={4} md={4}>
                      <span className="input-lable">Alphabet folder</span>
                      <input
                        className="input-field"
                        spellCheck="false"
                    ...
                    <Col xs={12} md={12}>
                      <span className="input-lable">Add your folder local path</span>
                      <textarea
                        className="input-field"
                        spellCheck="false"
